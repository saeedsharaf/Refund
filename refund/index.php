...
<div class="container"> <!-- this div it's main -->
	...
	<div class="menu"> <!-- div for refund & esclation -->
		<div class="refund">
                    <a class="active" href="redirect_page.php">compensation </a>
		</div>
		<div class="escalation">
                    <a href="../../escalation/config/redirect_page.php">escalation </a>
		</div>
...
'<form action="create.php" method="post" class="form-style-7">'+
	'<ul style="display: inline-flex;">'+
		...
		'<li>'+
			'<label for="name">Bss sr </label>'+
			'<input type="text" name="bss" maxlength="30" required >'+
			'<span>Please write BSS SR Here</span>'+
