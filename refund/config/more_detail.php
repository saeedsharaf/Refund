...
$sql = "SELECT * FROM re_srs WHERE sr ='$ser' "; 
...
if ($result->num_rows > 0){
   ...
   '<div class="more_color">' +           
	...
	'</tr>'+	
	'<tr class="more">'+
		'<td><label>BSS SR</label></td>'+
		'<td><div class="saeed"><span><?php echo $row['bss_sr'];?></span></div></td>'+
	...
	'<table class="more" >'+	
		...
		'<tr class="more">'+
				...
				'<input type="submit" class="reject" value="Suspend" name="suspend" >'+
...
<?php
	...
	'<tr class="more">'+
		...
		'<td><label >Handled By</label></td>'+
		'<td><div class="saeed" ><span><?php echo $row['handled_by'];?></span></div></td>'+

		'<td><label>Handled Time</label></td>'+
		'<td><div class="saeed" ><span><?php echo $row['handled_time'];?></span></div></td>'+
	'</tr>'+
	'</table>'+
