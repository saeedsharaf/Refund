...
if($_GET['export']){ 
if($_SESSION['ex'] == 'pc'){
	$sql = "select * from re_srs where date >= '$st_date' and date <= '$end_date' and status in ('Pending','Closed')";
...
$output .= '
		...
		$sql = "select * from re_srs where date >= '$st_date' and date <= '$end_date' and status in ('Pending','Rejected')";
...
$output .= '
		...
		$sql = "select * from re_srs where date >= '$st_date' and date <= '$end_date' and status in ('Closed','Rejected') ";
...
$output .= '
		...
		$sql = "select * from re_srs where date >= '$st_date' and date <= '$end_date' and status ='Pending'";
...
$output .= '
		...
		$sql= "select * from re_srs where date >= '$st_date' and date <= '$end_date' and status = 'Closed'";
...
$output .= '
		...
		$sql = "select * from re_srs where date >= '$st_date' and date <= '$end_date' and status = 'Rejected'";
...
$output .= '
		...
		$sql = "SELECT * FROM re_srs where date >= '$st_date' and date <= '$end_date' and status != 'Suspend'";
