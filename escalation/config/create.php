...
if ($submit){
		$sql = "INSERT INTO es_srs (sr, dial, created_date, status, name, description, created_by, handled_by, sla, type, feedback, handled_time , date) VALUES (NULL, '$dial', '$cur_time', 'Pending' , '$name', '$des', '$cr', '', '$time' , '$type', '', '','$date')";
