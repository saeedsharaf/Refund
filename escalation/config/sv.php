...
$sql1 = "SELECT * FROM es_srs "; //to select whole table re_srs to use it in super view 
...
$total = "SELECT status FROM es_srs WHERE status = 'Pending' or status = 'Suspend' "; // select the rows of pending to get total of result 
